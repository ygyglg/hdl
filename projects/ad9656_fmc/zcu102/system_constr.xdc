...
set_property  -dict {PACKAGE_PIN  K20  IOSTANDARD LVCMOS18} [get_ports iic_scl]                        ; ## C30  FMC_HPC0_IIC_SCL
set_property  -dict {PACKAGE_PIN  L20  IOSTANDARD LVCMOS18} [get_ports iic_sda]                        ; ## C31  FMC_HPC0_IIC_SDA
...
create_clock -name rx_div_clk     -period  16.00 [get_pins i_system_wrapper/system_i/util_ad9656_xcvr/inst/i_xch_0/i_gthe4_channel/RXOUTCLK]
